      ...
      <div className="w-[95%] h-14 bg-primaryColor rounded-b-sm md:flex hidden justify-between items-center">
        ...
        <div className="flex justify-center items-center relative">
          <div className="mr-8 flex justify-center items-center gap-2">
            ...
            <svg height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 291.764 291.764" xmlSpace="preserve">
              <g>
                <path style={{ fill: '#EFC75E' }} d="M145.882,0c80.573,0,145.882,65.319,145.882,145.882s-65.31,145.882-145.882,145.882S0,226.446,0,145.882S65.31,0,145.882,0z"/>
