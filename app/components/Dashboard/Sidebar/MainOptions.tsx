...
const MainOptions = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-transparent inset-0 flex justify-between items-center group-hover:text-redColor transition-colors duration-300 ${
          showElements && "text-redColor z-10"
        }`}
      >
        <div className="flex items-center gap-4">
          <motion.div
            ...
            // className={`${showElements && "bg-[#221D29] text-redColor"}}`}
          >
            {children}
          </motion.div>
